...
RSpec.describe AdminMailer, :type => :mailer do
  describe "notify_failed_gift" do
    ...
    it "renders the headers for mail without desc" do
      ...
      expect(mail.to).to eq(["support@comngood.org"])
      expect(mail.from).to eq(["support@comngood.org"])
    end
    ...
    it "renders the headers on mail with desc" do
      ...
      expect(mail_with_desc.to).to eq(["support@comngood.org"])
      expect(mail_with_desc.from).to eq(["support@comngood.org"])
    end
